...
try:
	...
	# on your sys.path.
	sys.path.append("/mnt/web502/e2/06/51276806/htdocs/.local/lib/python3.8/site-packages")
	sys.path.append("/mnt/web502/e2/06/51276806/htdocs/cgi-bin/dwitter")
	...
	#os.environ['DJANGO_SETTINGS_MODULE'] = 'dwitter.settings.base'
